                                ...
                                <table class="table no-border">
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: {{asset ('url(backend/images/gallery/creative/img-3.jpg)')}}"></div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: {{asset ('url(backend/images/gallery/creative/img-4.jpg)')}}"></div>
                                                </div>
