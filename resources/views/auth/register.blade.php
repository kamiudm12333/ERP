...
<head>
    ...
    <title>UDM School Managment System - Registration</title>
                ...
                <div class="col-lg-4 col-md-5 col-12">
                    ...
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                        ...
                        <div class="text-center">
                            <p class="mt-15 mb-0 text-white">Already have an account?<a href="{{ route('login') }}" class="text-danger ml-5"> {{ __('Already registered?') }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
