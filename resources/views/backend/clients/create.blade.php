...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Create a new client record</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="{{ route('clients.store') }}">
                ...
                <div class="mt-8 space-y-4">
                    <h3 class="text-lg font-medium text-gray-900 border-b border-gray-200 pb-2">Business Information</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="next_follow_up" class="block text-sm font-medium text-gray-700">Next Follow-up Date</label>
                            <input type="date" name="next_follow_up" id="next_follow_up" value="{{ old('next_follow_up') }}"
                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
