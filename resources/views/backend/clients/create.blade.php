                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Add New Client</h4>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form method="post" action="{{ route('clients.store') }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="number" name="total_business" class="form-control" step="0.01" min="0"> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <h5>Notes</h5>
                                                            <div class="controls">
                                                                <textarea name="notes" class="form-control" rows="4" placeholder="Additional notes about the client"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-xs-right">
                                            <input type="submit" class="btn btn-rounded btn-info mb-5" value="Add Client">
                                        </div>
                                    </form>
