            ...
            <div class="p-6">
                ...
                <form action="{{ route('clients.store') }}" method="POST">
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="last_contact" class="block text-sm font-medium text-gray-700">Last Contact</label>
                                <input type="datetime-local" name="last_contact" id="last_contact" value="{{ old('last_contact') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            </div>

                            <div>
                                <label for="next_follow_up" class="block text-sm font-medium text-gray-700">Next Follow-up</label>
                                <input type="datetime-local" name="next_follow_up" id="next_follow_up" value="{{ old('next_follow_up') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <a href="{{ route('clients.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg">
                            Cancel
                        </a>
