<nav class="bg-white border-b border-gray-200">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <div class="ml-3 relative">
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- Settings -->
                        <a href="{{ route('profile.view') }}" class="text-gray-400 hover:text-gray-500">
    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('clients.index') }}" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                Clients
            </a>
            ...
            <a href="{{ route('employees.index') }}" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                Employees
            </a>
