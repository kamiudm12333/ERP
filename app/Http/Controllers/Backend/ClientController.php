...
class ClientController extends Controller
{
    ...
    {
        $clients = Client::with('assignedEmployee')->latest()->paginate(15);
    ...
    public function create()
    {
        ...
        return view('backend.clients.create', compact('employees'));
    }
    ...
    {
        $client->load(['assignedEmployee', 'projects']);
    ...
    {
        $employees = User::where('role', 'employee')->orWhere('role', 'admin')->get();
        return view('backend.clients.edit', compact('client', 'employees'));
    }
